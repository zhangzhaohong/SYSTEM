...
<s:form action="modifyUserInfo" method="post" theme="simple">
    ...
    <table style="width:100%;border:0px solid black; border-spacing: 0px;padding: 0px;">
        <tr>
            <td class="title-bar">
    ...
    <table style="width:99%;border:0px solid black; border-spacing: 0px;padding: 0px;text-align:center; "
        ...
        <tr>
            ...
            <td style="height: 22px" colspan="3" class="table-cell-input"><span class="test_must"><b><s:label
                    name="userinfo.userTable.username"/> <s:hidden name="userinfo.userTable.id"/>
							<s:hidden name="userinfo.userTable.username"/>
							<s:hidden name="userinfo.userTable.userpwd"/> </b></span></td>
        </tr>
        <tr>
            <td style="height: 22px;text-align: right;" class="table-frame-input-title">密码：</td>
            <td style="width:35%;height: 22px;" class="table-cell-input"><span class="test_must"> <s:password
                    name="userpwd" value="userinfo.userTable.userpwd" cssClass="form_input" id="TITLE23" size="24"/>
            ...
            <td style="width:35%" class="table-cell-input"><span class="test_must"> <s:password name="userpwdag"
                                                                                                value="userinfo.userTable.userpwd"
                                                                                                cssClass="form_input"
                                                                                                id="TITLE24" size="24"/> * <img
        ...
        <tr>
            ...
            <td style="height: 22px" colspan="3" class="table-cell-input"><s:radio
                    list="#{'admin':'管理员','vip':'VIP','guest':'游客' }" name="userinfo.userTable.usertype"
                    value="userinfo.userTable.usertype"/></td>
        </tr>
    ...
    <table style="width:99%;border:0px solid black; border-spacing: 0px;padding: 0px;text-align:center; "
        ...
        <tr>
            ...
            <td style="width: 83%;height: 22px;" class="table-cell-input"><span class="test_must"> <s:textfield
                    name="userinfo.code" cssClass="form_input" size="32"/>
        ...
        <tr>
            ...
            <td style="width: 83%;height: 22px;" class="table-cell-input"><span class="test_must"> <s:textarea rows="5"
                                                                                                               cols="31"
                                                                                                               name="userinfo.remarks"
                                                                                                               cssClass="form_input"/>
				</span></td>
        </tr>
    </table>
    ...
    <table style="width:99%;border:0px solid black; border-spacing: 0px;padding: 0px;text-align:center; "
           class="buttun-bar">
        <tr>
            <td><s:submit cssClass="form-buttun" value="保 存"/> <input type="button" class="form-buttun" value="取 消"
                                                                      onClick="location.href='user_list.jsp'"></td>
        </tr>
    </table>
</s:form>
</body>
