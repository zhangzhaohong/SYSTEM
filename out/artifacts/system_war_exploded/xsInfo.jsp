...
<body bgcolor="#D9DFAA">
			...
			<td class="title-bar">
				<table style="width: 98%;border-spacing: 0;padding: 0;">
					<tr>
						...
						<td style="width: 745" class="title-bar-text">学生列表</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table style="width: 99%;border-spacing: 0;padding: 0;text-align: center;" class="oper-bar">
		<tr>
			...
			<td style="text-align: right;"><span class="title-bar"><input name="Submit22" type="button" class="form-button" value="添加" onClick="location.href='addXsInfo.jsp'"></span></td>
		</tr>
	</table>
	<table style="width: 100%;height:30px;border: 0;border-spacing: 0;padding: 0;">
		...
		<tr style="color: rgb(15,25,255);text-align: center;">
			...
			<td>
				<a href="deletestudent.action?student.sno=<s:property value="#student.sno"/>" onClick="if(!confirm('确定删除该生信息吗？'))return false;else return true;">删除</a>
			</td>
			<td>
