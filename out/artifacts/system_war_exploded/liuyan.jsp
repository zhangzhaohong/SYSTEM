...
<div style="width: 100%;">
	<s:form action="addLyAction" method="post" theme="simple">
		...
		<table style="width: 100%;border-spacing: 0;padding: 0;text-align: center;margin: 100px 0 0 0;" id="p1">
			<tr>
				<td style="width: 24%;height: 24px;background-color: rgb(239,246,254);" class="table-frame-input-title">留言标题</td>
			...
			<tr>
				<td style="width: 24%;height: 350px;line-height: 22;background-color: rgb(239,246,254);" class="table-frame-input-title">留言内容</td>
